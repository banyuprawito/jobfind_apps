...
import 'package:jobfinder/views/company_tab.dart';
import 'package:jobfinder/views/description_tab.dart';
          ...
          child: Row(
            children: <Widget>[
              Container(
                ...
                height: 50.0,
                decoration: BoxDecoration(
                  border: Border.all(color: kBlackAccent.withOpacity(.5)),
                  borderRadius: BorderRadius.circular(12.0),
                ),
                child: Icon(
